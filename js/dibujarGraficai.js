...
$( document ).ready(function(){
    $.ajax({
		...
		graficari(cantidades, horas);
	    }
	});
});

function graficari(Valores,Nombres){
    dataName = Nombres.split(",");
    q1Value = Valores.split(",").map(Number);

    var q2Value = [ 900000, 900000, 700000, 1800000 ];
    var q3Value = [ 800000, 700000, 600000, 900000 ];
    fillColor = ["#4D24D9", "#FFD40E", "#E60D8C", "#ACF70E", "#492FA2", "#EBC92E", "#BB247C", "#A3DC2B", "#2E2748", "#52622E", "#872D62", "#FFD40E", "#E60D8C", "#ACF70E"];
    // set this value for your data
    numSamples = 12;
    can = document.getElementById("cani");
    ctx = can.getContext("2d");
    drawPiei(dataName,q1Value);
}

function drawPiei(dataName,q1Value) {
    radius = can.height / 3;
